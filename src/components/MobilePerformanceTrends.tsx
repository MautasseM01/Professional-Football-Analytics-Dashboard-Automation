...
import { ChevronLeft, ChevronRight, TrendingUp, Eye, EyeOff } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              size="icon"
              onClick={prevChart}
              className="h-8 w-8 text-club-gold hover:bg-club-gold/10"
            >
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={performanceData} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                ...
                <Line 
                  ...
                  strokeWidth={2}
                  dot={{ fill: currentChartData.color, strokeWidth: 2, r: 3 }}
                  activeDot={{ r: 4, stroke: currentChartData.color, strokeWidth: 2 }}
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
