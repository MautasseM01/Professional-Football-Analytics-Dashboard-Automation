    ...
    <div className="space-y-6 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card className="bg-club-dark-gray border-club-gold/20">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-club-light-gray">{players.length}</div>
        ...
        <Card className="bg-club-dark-gray border-club-gold/20">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-club-light-gray">2</div>
        ...
        <Card className="bg-club-dark-gray border-club-gold/20">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-club-light-gray">24</div>
        ...
        <Card className="bg-club-dark-gray border-club-gold/20">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-club-light-gray">W-W-D</div>
