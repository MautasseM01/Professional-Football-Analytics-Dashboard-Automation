...
import { Calendar, Users, AlertTriangle, Clock, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {nextMatches.map((match, index) => {
              ...
              return (
                <div key={index} className="p-4 bg-club-black/40 rounded-lg">
          ...
          {injuries && injuries.length > 0 ? (
            <div className="space-y-4">
              {injuries.map((injury) => {
                ...
                return (
                  <div key={injury.id} className="p-4 bg-club-black/40 rounded-lg hover:bg-club-gold/10 transition-colors cursor-pointer">
