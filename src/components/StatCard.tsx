      ...
      <CardContent className="p-3 h-full flex flex-col justify-between min-h-[100px]">
        <div className="min-w-0 flex-1 space-y-2">
          ...
          <div className="space-y-1">
            <div className="text-lg font-bold text-club-gold light:text-yellow-600 break-words leading-tight group-hover:text-club-gold/90 light:group-hover:text-yellow-600/90 transition-colors duration-300">
              {value}
            </div>
            {subValue && (
