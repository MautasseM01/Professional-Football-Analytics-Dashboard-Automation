            ...
            <div className="relative">
              ...
              {showScrollHints && canScrollLeft && (
                <button
                  ...
                  className={cn(
                    ...
                    "backdrop-blur-sm border border-club-gold/40",
                    "flex items-center justify-center transition-all duration-200",
                    "text-club-gold hover:text-club-gold/80"
                  )}
              ...
              {canScrollLeft && (
                <div className={cn(
                  ...
                  "bg-gradient-to-r",
                  theme === 'dark' ? "from-club-dark-gray/80 to-transparent" : "from-white/80 to-transparent"
                )} />
              )}
                  ...
                  <thead className={cn(
                    ...
                    <tr>
                      <SortableHeader
                        ...
                        onSort={handleSort}
                        className={cn(
                          "sticky left-0 z-20 border-b border-club-gold/20 py-3 px-4",
                      ...
                      {visibleMetrics.map(metric => (
                        <SortableHeader
                          ...
                          className="text-center border-b border-club-gold/20 py-3 px-4"
                          ...
                          {visibleMetrics.map(metric => {
                            ...
                            return (
                              <td 
                                ...
                                className={cn(
                                  "text-center py-3 px-4 transition-all duration-200 h-16",
