  ...
  return <Card className={cn("border-club-gold/20 overflow-hidden backdrop-blur-sm transition-all duration-300", theme === 'dark' ? "bg-club-dark-gray/60" : "bg-white/80", "shadow-xl animate-fade-in")}>
      <CardHeader className="pb-2 sm:pb-3">
        <div className="flex flex-col gap-2 sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <CardTitle className={cn(responsiveClasses.headerText, theme === 'dark' ? "text-club-light-gray" : "text-gray-900", "truncate")}>
      ...
      <CardContent className="p-0">
        {loading ? <div className="p-3 sm:p-6">
            ...
            <div className={cn("w-full overflow-x-auto", "professional-scrollbar", theme === 'dark' ? "scrollbar-track-club-black/50 scrollbar-thumb-club-gold/60 hover:scrollbar-thumb-club-gold/80" : "scrollbar-track-gray-100/50 scrollbar-thumb-club-gold/70 hover:scrollbar-thumb-club-gold/90")} style={{
          scrollbarWidth: 'thin',
          scrollbarColor: theme === 'dark' ? '#D4AF37 #1A1A1A' : '#D4AF37 #F5F5F5'
        }}>
              <table className={cn("w-full border-separate border-spacing-0", "min-w-[480px]", "sm:min-w-[560px]", "lg:min-w-[800px]")}>
                ...
                <tbody>
                  {sortedPlayers.map((player, index) => <tr key={player.id} className={cn("transition-all duration-200 hover:shadow-md border-b", theme === 'dark' ? "border-club-gold/10 hover:bg-club-black/20 even:bg-club-black/10" : "border-club-gold/20 hover:bg-gray-50/50 even:bg-gray-25/25", index % 2 === 0 && "bg-opacity-50")}>
                      <td className={cn("sticky left-0 z-10 border-r", responsiveClasses.cellPadding, "w-[120px] sm:w-[140px] lg:w-[160px]", theme === 'dark' ? "bg-club-dark-gray/95 border-club-gold/10" : "bg-white/95 border-club-gold/20")}>
            ...
            {visibleMetrics.length < metrics.length && <div className="absolute bottom-2 right-2 flex items-center gap-2">
