...
export const TackleSuccessCard = ({ player }: TackleSuccessCardProps) => {
  ...
  return (
    <Card className={cn(
      ...
      <CardHeader className="p-4 sm:p-5 lg:p-6 pb-3 flex-shrink-0">
      ...
      <CardContent className="p-4 sm:p-5 lg:p-6 pt-0 flex-1 flex flex-col justify-between">
        ...
        {player.reportUrl && (
          <Button 
            ...
            size="sm"
            className={cn(
              "w-full border-club-gold/30 hover:bg-club-gold/10 hover:text-club-gold text-xs font-medium transition-all duration-300 rounded-xl mt-4",
              theme === 'dark' 
