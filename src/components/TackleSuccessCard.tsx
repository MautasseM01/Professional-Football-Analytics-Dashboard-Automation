  ...
  return (
    <Card className="border-club-gold/20 bg-club-dark-gray h-full transition-all duration-300 ease-in-out hover:border-club-gold/40 hover:shadow-lg group">
      <CardHeader className="p-4 sm:p-5 lg:p-6 pb-3">
        <CardTitle className="text-sm text-club-light-gray/70 font-medium">Tackle Success</CardTitle>
        <div className="text-xs text-club-light-gray/60">Defensive performance breakdown</div>
      </CardHeader>
      <CardContent className="p-4 sm:p-5 lg:p-6 pt-0 space-y-4">
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-2xl sm:text-3xl font-bold text-club-gold group-hover:text-club-gold/90 transition-colors duration-300">
              {tackleSuccessRate}%
            </span>
        ...
        {player.reportUrl && (
          <Button 
            ...
            variant="outline"
            size="sm"
            className="w-full border-club-gold/30 hover:bg-club-gold/10 hover:text-club-gold text-xs transition-all duration-300"
          >
