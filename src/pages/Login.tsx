...
const Login = () => {
  ...
  return <div className="min-h-screen flex items-center justify-center bg-club-black p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <img src="/lovable-uploads/eb223be6-87a6-402c-a270-20313a00080c.png" alt="Saint Martin D'Heres Football Club" className="w-24 h-24 mx-auto mb-2 rounded-lg" />
        ...
        <Card className="border-club-gold/20 bg-club-dark-gray">
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login">
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    <Input id="email" placeholder="Email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="bg-club-black border-club-gold/30 focus:border-club-gold" required />
                  </div>
                  <div className="space-y-2">
                  ...
                  <Button type="submit" className="w-full bg-club-gold text-club-black hover:bg-club-gold/80" disabled={isLoading}>
              ...
              <TabsContent value="register">
                <form onSubmit={handleSignUp} className="space-y-4">
                  <div className="space-y-2">
                    <Input id="register-email" placeholder="Email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="bg-club-black border-club-gold/30 focus:border-club-gold" required />
                  </div>
                  <div className="space-y-2">
                    <div className="relative">
          ...
          <CardFooter className="flex flex-col">
            ...
            <Button variant="outline" onClick={handleGoogleSignIn} className="w-full border-club-gold/30 hover:bg-club-gold/10">
