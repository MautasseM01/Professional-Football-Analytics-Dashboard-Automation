...
import { Target, TrendingUp, Calendar, MessageSquare, Star, Award, Menu, RefreshCw, Sparkles } from "lucide-react";
...
const PlayerDevelopment = () => {
  ...
  if (loading) {
    return (
      <div className="flex h-screen bg-gradient-to-br from-slate-900 via-club-black to-slate-900 text-gray-100 transition-colors duration-300">
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-900 via-club-black to-slate-900 text-gray-100 transition-colors duration-300">
      ...
      <div className="flex-1 overflow-auto min-w-0">
        ...
        <header className="border-b border-club-gold/20 bg-club-black/80 backdrop-blur-xl sticky top-0 z-20 transition-colors duration-300">
          <div className="flex justify-between items-center px-3 sm:px-4 lg:px-6 py-3 gap-2 sm:gap-4 sm:py-[20px]">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-ios-headline font-bold text-club-gold truncate">
                Player Development
              </h1>
              <p className="text-ios-caption text-gray-400 truncate">
                {profile?.role === 'player' 
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 flex-shrink-0">
              ...
              <TouchFeedbackButton 
                variant="outline" 
                size="icon" 
                className="bg-club-black/50 border-club-gold/30 hover:bg-club-gold/10 h-8 w-8 sm:h-9 sm:w-9 lg:h-10 lg:w-10 backdrop-blur-sm" 
