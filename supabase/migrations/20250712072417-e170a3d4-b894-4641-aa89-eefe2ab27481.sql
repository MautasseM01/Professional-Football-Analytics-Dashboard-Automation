...
-- Insert sample coach assessments with valid ratings (1-10 scale)
...
(1, '2024-01-15', 8, 9, 7, 8, 8, 'Excellent shot-stopping, commanding presence', 'Distribution accuracy, communication with defenders', 'Hamadi shows great potential as a first-team goalkeeper. Focus on building confidence with ball at feet.', 'Continue first team training', now()),
(13, '2024-01-10', 7, 7, 8, 8, 7, 'Strong in the air, good positioning', 'Ball control under pressure, passing range', 'Marc has solid defensive fundamentals. Work on technical skills to progress to first team.', 'Regular U23s matches', now()),
(14, '2024-01-12', 8, 8, 7, 7, 8, 'Pace, dribbling, finishing instinct', 'Physical strength, tactical awareness', 'Ibrahima has natural attacking talent. Needs physical development to handle senior football.', 'Gym program + tactical coaching', now());
